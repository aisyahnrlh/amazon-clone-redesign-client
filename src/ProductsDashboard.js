...
function ProductsDashboard({ title }) {
    return (
        <div className="productDashboard">
            <div className="productDashboard-title f aic jcsb">
                <p>{title}</p>
                <div className="productDashboard-titleCTA f aic">
            ...
            <div className="productDashboard-products f jcsb">
                <Product />
                <Product />
                <Product />
                <Product />
